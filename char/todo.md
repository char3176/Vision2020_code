...
# C-18/37 Tue 2020 02 18
  ...
  # Vision master-loop
    - implement video stream server
      - need <opencv2/opencv.hpp> at odin
      - need pip3 install robotpy-cscore at odin
  ...
  # ball
    x try supervise.ly
      x get dataset
      - check with Nathan about AWS account access
      - take additional pics of balls (jack)
      - label dataset
  ...
  # Turret
    - jake implementing encoder and motor control code in
