...
class G2Class:
    ...
    CP_LOCAL_FOCALLENGTHX = 1192.3 #ORIGINAL: 1192.3
    CP_LOCAL_FOCALLENGTHY = 1210.1 #ORIGINAL: 1210.1
    CP_LOCAL_CENTERPIXELOFFSETX = 334.23 #ORIGINAL: 334.23
    CP_LOCAL_CENTERPIXELOFFSETY = 376.71 #ORIGINAL: 376.71
...
#        #print(self.cX,self.cY)
    ...
    def doEverything(self):
        ...
        if self.isAG2:
            ...
            print("Angle: ", angle)
            print("Distance: ", (R2 * 1/0.0254)/12, " feet")
